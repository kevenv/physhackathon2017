function gui_init()
{
	...
	SourceControlA.add(sourceA, 'x', 0,100,1).onChange( function(value){ ssaoPass.x = value; });
	SourceControlA.add(sourceA, 'y', 0,100,1).onChange( function(value){ ssaoPass.y = value; });
